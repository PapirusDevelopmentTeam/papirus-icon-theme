...
sudo rm -rf /usr/local/share/icons/ePapirus
...
sudo cp -R \
  ...
  "$temp_dir/$gh_repo-master/Papirus-Light" /usr/local/share/icons/
sudo gtk-update-icon-cache -q "/usr/local/share/icons/ePapirus" || true
sudo gtk-update-icon-cache -q "/usr/local/share/icons/Papirus" || true
sudo gtk-update-icon-cache -q "/usr/local/share/icons/Papirus-Dark" || true
sudo gtk-update-icon-cache -q "/usr/local/share/icons/Papirus-Light" || true
echo "=> Clearing cache ..."
