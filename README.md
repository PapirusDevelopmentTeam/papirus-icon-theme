...
| Fedora        | Dirk Davidis       | `sudo dnf install papirus-icon-theme` <sup>official</sup> or [papirus-icon-theme](https://copr.fedorainfracloud.org/coprs/dirkdavidis/papirus-icon-theme/) <sup>copr</sup> |
